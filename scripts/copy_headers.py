...
parser = argparse.ArgumentParser(description="Update missing header files in the reduced data from the raw headers")
...
for file in tqdm.tqdm(files):
    ...
    raw_file = str(file).replace(str(folder), str(raw_folder)).replace("_reduced.fits", ".fits")
